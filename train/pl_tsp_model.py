...
from co_datasets.tsp_graph_dataset import TSPGraphDataset, TSPGraphDatasetinv2opt
from train.pl_meta_model import COMetaModel
...
class TSPModel(COMetaModel):
  def __init__(self,
    ...
    TSPGraphDs=TSPGraphDatasetinv2opt if self.args.rev2opt else TSPGraphDataset
        
    self.train_dataset = TSPGraphDs(
